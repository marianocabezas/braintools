...
int main(int argc, char **argv)
{
	...
	if (brainio->ReadProbabilityImage(atlasFolderName + "atlas_similarity.nii.gz") == (ProbabilityImage)NULL) {
		...
		brainreg->SetMoving(brainio->ReadIntensityImage("icbm452_atlas_template.nii"));
		brainreg->AddAtlas(brainio->ReadProbabilityImage("icbm452_atlas_probability_csf.nii"));
		brainreg->AddAtlas(brainio->ReadProbabilityImage("icbm452_atlas_probability_gray.nii"));
		brainreg->AddAtlas(brainio->ReadProbabilityImage("icbm452_atlas_probability_white.nii"));
		brainreg->RigidRegistration(3, 50);
		brainreg->AffineRegistration(3, 50);
